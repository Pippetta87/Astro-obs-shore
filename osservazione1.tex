...
\begin{itemize}
\item Circuito RLC risonante (ramato): $\nu_{ris}=\SI{23.1}{\mega\hertz}$ misurata per $\Gamma=-1$.%serieo so rso
\pgfmathsetmacro\nurso{23.1*10^6}
%nu resonance
\pgfmathsetmacro\omegarso{2*pi*\nurso} %omega resonance
\pgfmathsetmacro\cnomso{100*10^(-12)} %Condensatore serie 100PF??
%\edef\ctestso{100*10^(-12)} %Condensatore serie 100PF??
\pgfmathsetmacro\Lnomso{427*10^(-9)}%
%\edef\Ltestso{427*10^(-9)}%
\pgfmathsetmacro\rserieo{400*10^(-3)} %reistenza serie
%\edef\rtestso{400*10^(-3)} %reistenza serie
...
%$Q=\frac{\omega_0L}{r}=\pgfmathparse{(\omegarso*\Ltestso)*(\rtestso)^(-1)}\pgfmathprintnumber{\pgfmathresult}$.
%$Q=\frac{1}{\omega_0Cr}=\pgfmathparse{1/(\omegarso*\ctestso*\rtestso)}\pgfmathprintnumber{\pgfmathresult}$.
\item Circuito RLC risonante (argentato)  $\nu_{ris}=\SI{131.37}{\mega\hertz}$ misurata per $\Gamma=-1$.%st rst seriet
\pgfmathsetmacro\nurst{131.37*10^6}%nu resonance
\pgfmathsetmacro\omegarst{2*pi*\nurst}%omega resonance
\pgfmathsetmacro\rseriet{500*10^(-3)}%reistenza serie
\pgfmathsetmacro\Largst{144*10^(-9)}.%Valore ipotetico nominale induttanza argentata
Capacit\'a da frequenza: C=\pgfmathparse{((\omegarst^2)*\Largst)^(-1)}\edef\Cmisst{\pgfmathresult}
